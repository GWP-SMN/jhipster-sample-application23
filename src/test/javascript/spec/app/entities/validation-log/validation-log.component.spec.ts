...
import { ValidationLogComponent } from 'app/entities/validation-log/validation-log.component';
...
describe('Component Tests', () => {
    describe('ValidationLog Management Component', () => {
        let comp: ValidationLogComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ValidationLogComponent],
                providers: [
                    {
                ...
                .overrideTemplate(ValidationLogComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.validationLogs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
